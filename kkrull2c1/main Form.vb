...
' Purpose:      Program for testing numberic data types, ranges, and accuracy
' Programmer:   Kyle Krull on 10/12/2016

Option Strict On
Option Explicit On
Option Infer Off

Public Class kkrull2c1
    ...
    Private Sub btnDisplay_Click(sender As Object, e As EventArgs) Handles btnDisplay.Click
        ...
        lblSingle1.Text = long1.ToString
        lblSingle2.Text = long2.ToString
    ...
    Private Sub Label6_Click(sender As Object, e As EventArgs) Handles lblString1.Click
