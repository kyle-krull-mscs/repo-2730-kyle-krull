...
Public Class Form1
    ...
    Private Sub DisplayDelivery(ByVal partNum As String)
        ...
        If partNum.Length >= 3 AndAlso partNum.Length <= 4 AndAlso partNum.Substring(0, 2) Like
                "##" Then
    ...
    Private Sub btnProper_Click(sender As Object, e As EventArgs) Handles btnProper.Click
        ...
        Dim strLastChar As String = strName.Substring(index, 1).ToUpper
        Dim blank As Integer = txtName.Text.IndexOf(" ")

        If blank = -1 Then
            MessageBox.Show("Error: enter first and last name",
                                "input Error", MessageBoxButtons.OK,
                                MessageBoxIcon.Exclamation)
        Else
